...
<div class="row-2 alt">
 ...
 <form id="IPD" action="IpdInsert.jsp" method=post name="IPD">
              <fieldset>     
...
<tr>
     ...
     <tr><td></td>
        <td><center><br/><input style="height:25px;width:120px;font-size:10pt;" type="submit" value="SUBMIT" onclick="window.location.href='AssignPatientId.jsp'" ></center></td> 
