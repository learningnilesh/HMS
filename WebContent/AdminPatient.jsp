               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                     	...
                     	<li><a href="AdminPatient.jsp" class="current">PATIENT DETAILS</a></li>
...
<td></td>
        ...
        <td> <input  style="height:25px;width:120px;font-size:10pt;" type="button" value="EDIT" onclick="window.location.href='AdminEditIpd.jsp?id=<%=id_patient %>'" /></td>
