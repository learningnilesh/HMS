...
out.print( "<h2 align=\"center\">"+id_patient+"</h2>");
...
int bill_amount=reg_charges1+bed_charges_amount1+doctor_charges_amount1+nursing_charges_amount1+operation_chargesamount1+theatre_charges1+transfusion_charges_amount1+monitor_chargesamount1+injection_chargesamount1+oxygen_chargesamount1+ventilator_chargesamount1+tapping_charges_amount1+bsl_chargesamount1+ecg_chargesamount1+rt_catheter_chargesamount1+nebulilzation_chargesamount1+emergency_chargesamount1+physiotherapy_chargesamount1;
     ...
     Class.forName("com.mysql.jdbc.Driver");
       ...
       Statement st=con.createStatement();
      																 																					//st.executeUpdate("UPDATE biling_tb SET (id_patient,patient_name,patient_id,reg_charges,bed_icu,bed_semiicu,bed_sproom,bed_gward,bed_icu_charges_day,bed_semiicu_charges_day,bed_sproom_charges_day,bed_gward_charges_day,bed_charges_amount,doctor_charges_icu,doctor_charges_semiicu,doctor_charges_sproom,doctor_charges_gward,doctor_icu_charges_day,doctor_semiicu_charges_day,doctor_sproom_charges_day,doctor_gward_charges_day,doctor_charges_amount,nursing_charges_icu,nursing_charges_semiicu,nursing_charges_sproom,nursing_charges_gward,nursing_icu_charges_day,nursing_semiicu_charges_day,nursing_sproom_charges_day,nursing_gward_charges_day,nursing_charges_amount,operation_charges,operation_charges_operations,operation_charges_amount,theatre_charges,theatre_charges_amount,transfusion_blood,transfusion_ffp,transfusion_rdp,transfusion_albumin,transfusion_bloodcharges_items,transfusion_ffpcharges_items,transfusion_rdpcharges_items,transfusion_albumincharges_items,transfusion_charges_amount,injection_charges,injection_charges_items,injection_charges_amount,monitor_charges,monitor_charges_items,monitor_charges_amount,oxygen_charges,oxygen_charges_items,oxygen_charges_amount,ventilator_charges,ventilator_charges_items,ventilator_charges_amount,tapping_abd,tapping_pleural,tapping_csf,tapping_stich,tapping_abdcharges_items,tapping_pleuralcharges_items,tapping_csfcharges_items,tapping_stichcharges_items,tapping_charges_amount,bsl_charges,bsl_charges_items,bsl_charges_amount,ecg_charges,ecg_charges_items,ecg_charges_amount,rt_catheter_charges,rt_catheter_charges_items,rt_catheter_charges_amount,nebulization_charges,nebulization_charges_items,nebulization_charges_amount,emergency_charges,emergency_charges_items,emergency_charges_amount,physiotherapy_charges,physiotherapy_charges_items,physiotherapy_charges_amount) 
    																																								   /*values('"+id_patient+"','"+patient_name+"','"+patient_id+"','"+reg_charges+"','"+bed_icu+"','"+bed_semiicu+"','"+bed_sproom+"','"+bed_gward+"','"+bed_icu_charges_day+"','"+bed_semiicu_charges_day+"','"+bed_sproom_charges_day+"','"+bed_gward_charges_day+"','"+bed_charges_amount+"','"+doctor_icu+"','"+doctor_semiicu+"','"+doctor_sproom+"','"+doctor_gward+"','"+doctor_icu_charges_day+"','"+doctor_semiicu_charges_day+"','"+doctor_sproom_charges_day+"','"+doctor_gward_charges_day+"','"+doctor_charges_amount+"','"+nursing_icu+"','"+nursing_semiicu+"','"+nursing_sproom+"','"+nursing_gward+"','"+nursing_icu_charges_day+"','"+nursing_semiicu_charges_day+"','"+nursing_sproom_charges_day+"','"+nursing_gward_charges_day+"','"+nursing_charges_amount+"','"+operation_charges+"','"+operation_charges_operations+"','"+operation_charges_amount+"','"+theatre_charges+"','"+theatre_charges+"','"+transfusion_blood+"','"+transfusion_ffp+"','"+transfusion_rdp+"','"+transfusion_albumin+"','"+transfusion_bloodcharges_items+"','"+transfusion_ffpcharges_items+"','"+transfusion_rdpcharges_items+"','"+transfusion_albumincharges_items+"','"+transfusion_charges_amount+"','"+injection_charges+"','"+injection_charges_items+"','"+injection_chargesamount+"','"+monitor_charges+"','"+monitor_charges_items+"','"+monitor_chargesamount+"','"+oxygen_charges+"','"+oxygen_charges_items+"','"+oxygen_chargesamount+"','"+ventilator_charges+"','"+ventilator_charges_items+"','"+ventilator_chargesamount+"','"+tapping_abd+"','"+tapping_pleural+"','"+tapping_csf+"','"+tapping_stich+"','"+tapping_abdcharges_items+"','"+tapping_pleuralcharges_items+"','"+tapping_csfcharges_items+"','"+tapping_stichcharges_items+"','"+tapping_charges_amount+"','"+bsl_charges+"','"+bsl_charges_items+"','"+bsl_chargesamount+"','"+ecg_charges+"','"+ecg_charges_items+"','"+ecg_chargesamount+"','"+rt_catheter_charges+"','"+rt_catheter_charges_items+"','"+rt_catheter_chargesamount+"','"+nebulilzation_charges+"','"+nebulilzation_charges_items+"','"+nebulilzation_chargesamount+"','"+emergency_charges+"','"+emergency_charges_items+"','"+emergency_chargesamount+"','"+physiotherapy_charges+"','"+physiotherapy_charges_items+"','"+physiotherapy_chargesamount+"'  WHERE id_patient='"+id_patient+"')");*/
           										                                                              					/*values('"+id_patient+"','"+patient_name+"','"+patient_id+"','"+reg_charges+"','"+bed_icu+"','"+bed_semiicu+"','"+bed_sproom+"','"+bed_gward+"','"+bed_icu_charges_day+"','"+bed_semiicu_charges_day+"','"+bed_sproom_charges_day+"','"+bed_gward_charges_day+"',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,  WHERE id_patient='"+id_patient+"')");*/
 st.executeUpdate("UPDATE biling_tb SET id_patient='"+id_patient+"',patient_name='"+patient_name+"',patient_id='"+patient_id+"',reg_charges='"+reg_charges+"',bed_icu='"+bed_icu+"',bed_semiicu='"+bed_semiicu+"',bed_sproom='"+bed_sproom+"',bed_gward='"+bed_gward+"',bed_icu_charges_day='"+bed_icu_charges_day+"',bed_semiicu_charges_day='"+bed_semiicu_charges_day+"',bed_sproom_charges_day='"+bed_sproom_charges_day+"',bed_gward_charges_day='"+bed_gward_charges_day+"',bed_charges_amount='"+bed_charges_amount+"',doctor_charges_icu='"+doctor_icu+"',doctor_charges_semiicu='"+doctor_semiicu+"',doctor_charges_sproom='"+doctor_sproom+"',doctor_charges_gward='"+doctor_gward+"',doctor_icu_charges_day='"+doctor_icu_charges_day+"',doctor_semiicu_charges_day='"+doctor_semiicu_charges_day+"',doctor_sproom_charges_day='"+doctor_sproom_charges_day+"',doctor_gward_charges_day='"+doctor_gward_charges_day+"',doctor_charges_amount='"+doctor_charges_amount+"',nursing_charges_icu='"+nursing_icu+"',nursing_charges_semiicu='"+nursing_semiicu+"',nursing_charges_sproom='"+nursing_sproom+"',nursing_charges_gward='"+nursing_gward+"',nursing_icu_charges_day='"+nursing_icu_charges_day+"',nursing_semiicu_charges_day='"+nursing_semiicu_charges_day+"',nursing_sproom_charges_day='"+nursing_sproom_charges_day+"',nursing_gward_charges_day='"+nursing_gward_charges_day+"',nursing_charges_amount='"+nursing_charges_amount+"',operation_charges='"+operation_charges+"',operation_charges_operations='"+operation_charges_operations+"',operation_charges_amount='"+operation_charges_amount+"',theatre_charges='"+theatre_charges+"',theatre_charges_amount='"+theatre_charges+"',transfusion_blood='"+transfusion_blood+"',transfusion_ffp='"+transfusion_ffp+"',transfusion_rdp='"+transfusion_rdp+"',transfusion_albumin='"+transfusion_albumin+"',transfusion_bloodcharges_items='"+transfusion_bloodcharges_items+"',transfusion_ffpcharges_items='"+transfusion_ffpcharges_items+"',transfusion_rdpcharges_items='"+transfusion_rdpcharges_items+"',transfusion_albumincharges_items='"+transfusion_albumincharges_items+"',transfusion_charges_amount='"+transfusion_charges_amount+"',injection_charges='"+injection_charges+"',injection_charges_items='"+injection_charges_items+"',injection_charges_amount='"+injection_chargesamount+"',monitor_charges='"+monitor_charges+"',monitor_charges_items='"+monitor_charges_items+"',monitor_charges_amount='"+monitor_chargesamount+"',oxygen_charges='"+oxygen_charges+"',oxygen_charges_items='"+oxygen_charges_items+"',oxygen_charges_amount='"+oxygen_chargesamount+"',ventilator_charges='"+ventilator_charges+"',ventilator_charges_items='"+ventilator_charges_items+"',ventilator_charges_amount='"+ventilator_chargesamount+"',tapping_abd='"+tapping_abd+"',tapping_pleural='"+tapping_pleural+"',tapping_csf='"+tapping_csf+"',tapping_stich='"+tapping_stich+"',tapping_abdcharges_items='"+tapping_abdcharges_items+"',tapping_pleuralcharges_items='"+tapping_pleuralcharges_items+"',tapping_csfcharges_items='"+tapping_csfcharges_items+"',tapping_stichcharges_items='"+tapping_stichcharges_items+"',tapping_charges_amount='"+tapping_charges_amount+"',bsl_charges='"+bsl_charges+"',bsl_charges_items='"+bsl_charges_items+"',bsl_charges_amount='"+bsl_chargesamount+"',ecg_charges='"+ecg_charges+"',ecg_charges_items='"+ecg_charges_items+"',ecg_charges_amount='"+ecg_chargesamount+"',rt_catheter_charges='"+rt_catheter_charges+"',rt_catheter_charges_items='"+rt_catheter_charges_items+"',rt_catheter_charges_amount='"+rt_catheter_chargesamount+"',nebulization_charges='"+nebulilzation_charges+"',nebulization_charges_items='"+nebulilzation_charges_items+"',nebulization_charges_amount='"+nebulilzation_chargesamount+"',emergency_charges='"+emergency_charges+"',emergency_charges_items='"+emergency_charges_items+"',emergency_charges_amount='"+emergency_chargesamount+"',physiotherapy_charges='"+physiotherapy_charges+"',physiotherapy_charges_items='"+physiotherapy_charges_items+"',physiotherapy_charges_amount='"+physiotherapy_chargesamount+"',bill_amonut='"+bill_amount+"'  WHERE id_patient='"+id_patient+"'");
