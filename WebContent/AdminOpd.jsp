 ...
 <div class="row-2 alt">
               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                        ...
                        <li><a href="AdminIpd.jsp">IPD</a></li>
                        <li><a href="AdminOpd.jsp" class="current">OPD</a></li>
        ...
        <div class="indent"> 
          ...
          <div class="extra-wrap"> 
                    ...
                    <form id="OPD" action="AdminInsertOpdRecord.jsp" id="OPD" method="post"> 
<fieldset>
...
<tr>
      ...
      -->
    	 ...
    	 <tr>
          ...
          <table width="140%" align="center" cellpadding="10" cellspacing="20" style="width:500px;margin-left:70px;">
