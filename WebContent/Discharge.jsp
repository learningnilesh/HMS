               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                     	...
                     	<li><a href="Discharge.jsp"  class="current">DISCHARGE</a></li>
...
%>
 ...
 <form  id="DISCHARGE" action="GiveDischarge.jsp" method=post name="DISCHARGE">
              <fieldset>     
...
%>
	...
	<tr>
        <td><center><br/><input style="height:25px;width:120px;font-size:10pt;" type="submit" value="DISCHARGE" onClick="Confirm(this.IPD)" ></center></td> 
