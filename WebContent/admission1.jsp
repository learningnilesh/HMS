               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                        ...
                        <li><a href="admission1.jsp" class="current">IPD</a></li>
...
<table width="160%" align="center" cellpadding="10" cellspacing="20">
		<tr>
         ...
         <td><input type="Text" id="doa" name="date_of_admit" class="validate[required] size="25" ><a href="javascript:NewCal('doa','ddmmyyyy','arrow',true,'12',true)"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
	  		
   	      <td>DOD and Time</td>
         <td> <input type="Text"  id="dod" name="date_of_discharge" size="25"><a href="javascript:NewCal('dod','ddmmyyyy','arrow',true,'12',true)"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
     </tr>
     	 <tr>
...
<tr>
          ...
          <td><p><input type="text" name="mlc_policestn"   ></p></td>
          
          
          <td><p class="ex1">Police Name:</p></td>
          <td><p><input type="text" name="mlc_policename"  ></p></td>
     </tr>
     	 <tr>
          <td><p >MLC Reg on Date:</p></td>
          <td><input type="Text" id="mlcregi" name="mlc_regi_date"><a href="javascript:NewCal('mlcregi','ddmmyyyy','arrow',true,'12',true)"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
