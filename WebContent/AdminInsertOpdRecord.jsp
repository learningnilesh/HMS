...
String ipd_no="OPD"+year+id_patient;
...
try{
     Class.forName("com.mysql.jdbc.Driver");
       ...
       int i=st.executeUpdate("insert into patient(patient_name,patient_id,age,gender,address,marital_status,occupation,phone_no) values('"+patient_name+"','"+ipd_no+"','"+age+"','"+gender+"','"+address+"','"+marital_status+"','"+occupation+"','"+phone_no+"')");
       response.sendRedirect("AdminOpd.jsp");
    }
    catch(Exception e){
    System.out.print(e);
    e.printStackTrace();
