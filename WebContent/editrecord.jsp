...
try{
         Class.forName("com.mysql.jdbc.Driver");
           ...
           st.executeUpdate("UPDATE patient SET patient_name='"+patient_name+"','"+age+"','"+address+"','"+marital_status+"','"+phone_no+"' WHERE id_patient="+Integer.parseInt(id_patient)+"");
           
           response.sendRedirect("testIpdEdit.jsp?status=true");
