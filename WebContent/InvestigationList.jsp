               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                     	...
                     	<li><a href="AnotherPatient.jsp">Another Patient</a></li>
    ...
    Class.forName("com.mysql.jdbc.Driver");
      ...
      while(rs.next())
      {
    	 ...
    	 String getdate=rs.getString("date");
    	  ...
    	  <td><a href="InvestigationView.jsp?date=<%=getdate%>">View</a></td>
    	  <td><a href="InvestigationEdit.jsp?date=<%=getdate%>">Edit</a></td>
...
<tr><td><center>
<br><input style="height:25px;width:120px;font-size:10pt;" type="button" value="ADD RECORD" onclick="window.location.href='Investigationsheet.jsp'" /></center></td>
</tr>
</table>
</body>
</html>
