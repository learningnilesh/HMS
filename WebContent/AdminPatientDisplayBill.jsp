...
<tr>
         <td></td><td></td>
        <td> <input  style="height:25px;width:120px;font-size:10pt;" type="button" value="EDIT" onclick="window.location.href='AdminEditPatientBill.jsp?id=<%=id_patient %>'" /></td>
...
if ( ps.executeQuery() == null )
	 //out.println("If record not exist click here..");
	  ...
	  <td> <input  style="height:25px;width:120px;font-size:10pt;" type="button" value="Add" onclick="window.location.href='AdminAddCharges.jsp?id=<%=id_patient1%>'" /></td>
