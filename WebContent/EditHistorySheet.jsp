...
<div class="boxed">
<form  action="EditHistorySheetFinal.jsp" method=post name="HISTORYSHEET">
...
<td><b><font size="2.5" style="color:white;background-color:grey;font:700 10pt verdana">PATIENT DIAGNOSIS:</font></b></td>
  ...
  <td><b><font size="2.5" style="color:white;background-color:grey;font:700 10pt verdana">PAST INFO:</font></b></td>
     ...
     <tr>
          ...
          <td><input type="checkbox" name="dm" value="YES" <%=("YES".equals(rs.getString("dm"))?"checked='checked'":"")%>></td>
         
         <td><br/>ASTHMA</td>
          <td><br/><input   type="checkbox" name="asthma" value="YES" <%=("YES".equals(rs.getString("asthma"))?"checked='checked'":"")%> /></td>
          
      </tr>
          <tr>
          <td><br>TB</td>
          <td><br/><input   type="checkbox" name="tb" value="YES" <%=("YES".equals(rs.getString("tb"))?"checked='checked'":"")%> /></td>
          
          
          <td><br>HTN</td>
          <td><br/><input   type="checkbox" name="htn" value="YES" <%=("YES".equals(rs.getString("htn"))?"checked='checked'":"")%> /></td>
        
        </tr>
          <tr>  
          <td><br>IHD</td>
          <td><br/><input   type="checkbox" name="ihd" value="YES" <%=("YES".equals(rs.getString("ihd"))?"checked='checked'":"")%> /></td>
    
          
          <td><br>CVA</td>
          <td><br/><input   type="checkbox" name="cva" value="YES" <%=("YES".equals(rs.getString("cva"))?"checked='checked'":"")%> /></td>
      </tr>
    <tr>   
          <td><br>EPILEPSY</td>
          <td><br/><input   type="checkbox" name="epilepsy" value="YES" <%=("YES".equals(rs.getString("epilepsy"))?"checked='checked'":"")%> /></td>
          
          
          <td><br>COPD</td>
          <td><br/><input   type="checkbox" name="copd" value="YES" <%=("YES".equals(rs.getString("copd"))?"checked='checked'":"")%> /></td>
     </tr>
          <tr>     
          <td><br>CKD</td>
          <td><br/><input   type="checkbox" name="ckd" value="YES" <%=("YES".equals(rs.getString("ckd"))?"checked='checked'":"")%> /></td>
  ...
  <tr>
     ...
     <tr>
          ...
          <tr>
  			 <td><br>ALCOHOL</td>
          <td><br/><input   type="checkbox" name="alcohol" value="YES" <%=("YES".equals(rs.getString("alcohol"))?"checked='checked'":"")%> /></td>
          
          <td><br>TOBACCO</td>
          <td><br/><input   type="checkbox" name="tobacco" value="YES" <%=("YES".equals(rs.getString("tobacco"))?"checked='checked'":"")%> /></td>
          </tr>
          <tr>
          <td><br>SMOKING</td>
          <td><br/><input   type="checkbox" name="smoking" value="YES" <%=("YES".equals(rs.getString("smoking"))?"checked='checked'":"")%> /></td>
          
          <td><br>PAN/GUTKHA</td>
          <td><br/><input   type="checkbox" name="pangutkha" value="YES" <%=("YES".equals(rs.getString("pangutkha"))?"checked='checked'":"")%> /></td>
