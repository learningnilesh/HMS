               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                     	...
                     	<li><a href="AdminEditHistoryRecord.jsp" class="current">HISTORYSHEET</a></li>
...
<tr>
<td></td>
      <td> <input  style="height:25px;width:120px;font-size:10pt;" type="button" value="EDIT" onclick="window.location.href='AdminEditHistorySheet.jsp?id=<%=id_patient %>'" /></td>
...
if ( ps.executeQuery() == null )
	 //out.println("If record not exist click here..");
	  ...
	  <td> <input  style="height:25px;width:120px;font-size:10pt;" type="button" value="Add" onclick="window.location.href='AdminHistorysheet.jsp?id=<%=id_patient1 %>'" /></td>
