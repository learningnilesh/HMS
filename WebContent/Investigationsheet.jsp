...
<div class="row-2 alt">
               ...
               <div class="header-box-small">
                  <div class="inner">
                     <ul class="nav">
                        ...
                        <li><a href="Investigation.jsp" class="current">Investigation</a></li>
        ...
        <form  action="insertrecordInvi.jsp" method=post name="INVESTIGATION">    
...
<tr>
 <td><br/>Date</td>
         ...
         <td><br/><input  type="Text" id="doa" name="date" size="17"><a href="javascript:NewCal('doa','ddmmyyyy','arrow',true,'12',true)"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"></a></td>
...
<table width="100%" align="center" cellpadding="10" cellspacing="20">         
     ...
     <tr>
     		<td>Worms</td>
          <td><input type="text" name="worms"></td>
...
<table width="100%" align="center" cellpadding="10" cellspacing="20">   
     ...
     <tr>
          ...
          <td><input type="text" name="sugar" ></td>
     		...
     		<td>TLC</td>
          <td><input type="text" name="fluid_tlc"></td>
...
<table width="100%" style="width:500px;margin-left:200px;" align="center" cellpadding="10" cellspacing="20">
	<tr>
